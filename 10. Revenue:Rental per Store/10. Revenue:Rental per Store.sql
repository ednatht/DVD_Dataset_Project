select   g.country,f.city, b.address,
sum(e.amount) as rental_revenue ,count(d.rental_id) as rental_count
, sum(e.amount)/count(d.rental_id) as Revenue_per_Rental from
store a 
