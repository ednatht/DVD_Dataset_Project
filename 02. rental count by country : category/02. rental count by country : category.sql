...
left join inventory f on a.inventory_id = f.inventory_id
left join film g on f.film_id = g.film_id
left join film_category h on g.film_id = h.film_id
left join category i on h.category_id = i.category_id
